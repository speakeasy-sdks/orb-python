...
req = operations.CreateSubscriptionApplicationJSON(
    ...
    coupon_redemption_code='numquam',
    customer_id='97DPcZE9hxsbb9Y9',
    default_invoice_memo='impedit',
    external_customer_id='explicabo',
    external_marketplace=operations.CreateSubscriptionApplicationJSONExternalMarketplace.GOOGLE,
    external_marketplace_reporting_id='project_number:983410661111',
    external_plan_id='voluptas',
    metadata={
        "dignissimos": 'dicta',
    },
    minimum_amount='1.23',
    ...
    phase_overrides=[
        operations.CreateSubscriptionApplicationJSONPhaseOverrides(
            discount=shared.Discount(
                ...
                trial_amount_discount='quaerat',
                usage_discount=1629.54,
            ),
        ...
        operations.CreateSubscriptionApplicationJSONPhaseOverrides(
            discount=shared.Discount(
                ...
                discount_type=shared.DiscountDiscountType.PERCENTAGE,
                percentage_discount=0.15,
                trial_amount_discount='nemo',
                usage_discount=653.04,
            ),
        ...
        operations.CreateSubscriptionApplicationJSONPhaseOverrides(
            discount=shared.Discount(
                ...
                usage_discount=6625.05,
            ),
            minimum_amount='suscipit',
            order=2460.63,
        ),
    ],
    plan_id='ZMwNQefe7J3ecf7W',
    price_overrides=[
        operations.CreateSubscriptionApplicationJSONPriceOverrides5(
            bps_config=operations.CreateSubscriptionApplicationJSONPriceOverrides5BpsConfig(
                bps=9268.8,
                per_unit_maximum='totam',
            ),
            discount=shared.CreateDiscount(
                amount_discount='fugiat',
                discount_type=shared.CreateDiscountDiscountType.USAGE,
                percentage_discount='ducimus',
                usage_discount='quos',
            ),
            id='64dbb675-fd5e-460b-b75e-d4f6fbee41f3',
            minimum_amount='1.23',
            model_type=operations.CreateSubscriptionApplicationJSONPriceOverrides5ModelType.BPS,
        ),
        operations.CreateSubscriptionApplicationJSONPriceOverrides2(
            discount=shared.CreateDiscount(
                amount_discount='amet',
                discount_type=shared.CreateDiscountDiscountType.PERCENTAGE,
                percentage_discount='dignissimos',
                usage_discount='a',
            ),
            fixed_price_quantity=891523,
            id='35b60eb1-ea42-4655-9ba3-c28744ed53b8',
            minimum_amount='1.23',
            model_type=operations.CreateSubscriptionApplicationJSONPriceOverrides2ModelType.UNIT,
            unit_config=operations.CreateSubscriptionApplicationJSONPriceOverrides2UnitConfig(
                unit_amount='quas',
            ),
        ),
        operations.CreateSubscriptionApplicationJSONPriceOverrides7(
            discount=shared.CreateDiscount(
                amount_discount='nesciunt',
                discount_type=shared.CreateDiscountDiscountType.USAGE,
                percentage_discount='corrupti',
                usage_discount='pariatur',
            ),
            id='8f5c0b2f-2fb7-4b19-8a27-6b26916fe1f0',
            minimum_amount='1.23',
            model_type=operations.CreateSubscriptionApplicationJSONPriceOverrides7ModelType.TIERED_BPS,
            tiered_bps_config=operations.CreateSubscriptionApplicationJSONPriceOverrides7TieredBpsConfig(
                tiers=[
                    operations.CreateSubscriptionApplicationJSONPriceOverrides7TieredBpsConfigTiers(
                        bps=9795.74,
                        maximum_amount='incidunt',
                        minimum_amount='sed',
                        per_unit_maximum='provident',
                    ),
                    operations.CreateSubscriptionApplicationJSONPriceOverrides7TieredBpsConfigTiers(
                        bps=2587.02,
                        maximum_amount='necessitatibus',
                    ...
                    operations.CreateSubscriptionApplicationJSONPriceOverrides7TieredBpsConfigTiers(
                        bps=5799.12,
                        maximum_amount='quos',
                        minimum_amount='voluptatibus',
                        per_unit_maximum='tempora',
                    ),
                ],
            ),
        ),
...
res = s.subscription.fetch('tempora')
...
res = s.subscription.fetch_schedule('sit')
...
res = s.subscription.list('quaerat', 'incidunt')
...
res = s.subscription.schedule_plan_change('ipsam', operations.SchedulePlanChangeRequestBody(
    align_billing_with_plan_change_date=False,
    change_date=dateutil.parser.isoparse('2017-07-21T17:32:28Z'),
    change_option=operations.SchedulePlanChangeRequestBodyChangeOption.IMMEDIATE,
    coupon_redemption_code='rem',
            ...
            bulk_bps_config=operations.SchedulePlanChangeRequestBodyPriceOverrides6BulkBpsConfig(
                tiers=[
                    operations.SchedulePlanChangeRequestBodyPriceOverrides6BulkBpsConfigTiers(
                        bps=3335.07,
                        maximum_amount='minima',
                        per_unit_maximum='recusandae',
                    ),
                    operations.SchedulePlanChangeRequestBodyPriceOverrides6BulkBpsConfigTiers(
                        bps=9671.22,
                        maximum_amount='nulla',
                        per_unit_maximum='magni',
                    ),
                    operations.SchedulePlanChangeRequestBodyPriceOverrides6BulkBpsConfigTiers(
                        bps=486.9,
...
res = s.subscription.unschedule_cancellation('consequatur')
...
res = s.subscription.unschedule_plan_change('esse')
...
res = s.subscription.update_fixed_fee_quantity('ipsam', operations.UpdateFixedFeeQuantityRequestBody(
