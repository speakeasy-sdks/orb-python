...
class Customer:
    ...
    def create(self, request: operations.PostCustomersRequestBody) -> operations.PostCustomersResponse:
        r"""Create customer
    ...
    def get(self, request: operations.GetExternalCustomerCostsRequest) -> operations.GetExternalCustomerCostsResponse:
