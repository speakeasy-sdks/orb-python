...
class Plan:
    ...
    def get(self, request: operations.GetPlansExternalPlanIDRequest) -> operations.GetPlansExternalPlanIDResponse:
    ...
    def get(self, request: operations.GetPlansRequestBody) -> operations.GetPlansResponse:
        r"""List plans
