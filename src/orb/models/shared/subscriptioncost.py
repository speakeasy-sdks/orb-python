...
class SubscriptionCostPerPriceCostsPriceGroups:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SubscriptionCostPerPriceCosts:
    r"""Price's contributions for the timeframe, excluding any transforms (minimums and discounts)."""
    
    price_groups: list[SubscriptionCostPerPriceCostsPriceGroups] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_groups') }})
...
class SubscriptionCost:
    ...
    per_price_costs: list[SubscriptionCostPerPriceCosts] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('per_price_costs') }})
