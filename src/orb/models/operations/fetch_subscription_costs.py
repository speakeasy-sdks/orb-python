...
class FetchSubscriptionCosts200ApplicationJSONDataPerPriceCosts:
    ...
    price_groups: list[FetchSubscriptionCosts200ApplicationJSONDataPerPriceCostsPriceGroups] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_groups') }})
...
class FetchSubscriptionCosts200ApplicationJSONData:
    ...
    per_price_costs: list[FetchSubscriptionCosts200ApplicationJSONDataPerPriceCosts] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('per_price_costs') }})
...
class FetchSubscriptionCosts200ApplicationJSON:
    ...
    data: list[FetchSubscriptionCosts200ApplicationJSONData] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})
...
class FetchSubscriptionCostsResponse:
    ...
    fetch_subscription_costs_200_application_json_object: Optional[FetchSubscriptionCosts200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""
