...
class FetchCustomerCostsExternalIDViewMode(str, Enum):
...
class FetchCustomerCostsExternalIDRequest:
    ...
    view_mode: Optional[FetchCustomerCostsExternalIDViewMode] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'view_mode', 'style': 'form', 'explode': True }})
    r"""Controls whether Orb returns cumulative costs since the start of the billing period, or incremental day-by-day costs. If your customer has minimums or discounts, it's strongly recommended that you use the default cumulative behavior."""
...
class FetchCustomerCostsExternalID200ApplicationJSONDataPerPriceCosts:
    ...
    price_groups: list[FetchCustomerCostsExternalID200ApplicationJSONDataPerPriceCostsPriceGroups] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_groups') }})
...
class FetchCustomerCostsExternalID200ApplicationJSONData:
    ...
    per_price_costs: list[FetchCustomerCostsExternalID200ApplicationJSONDataPerPriceCosts] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('per_price_costs') }})
...
class FetchCustomerCostsExternalID200ApplicationJSON:
    ...
    data: list[FetchCustomerCostsExternalID200ApplicationJSONData] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})
...
class FetchCustomerCostsExternalIDResponse:
    ...
    fetch_customer_costs_external_id_200_application_json_object: Optional[FetchCustomerCostsExternalID200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""
