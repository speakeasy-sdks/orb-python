...
class CreateLedgerEntryRequestBodyEntryType(str, Enum):
    INCREMENT = 'increment'
    DECREMENT = 'decrement'
...
class CreateLedgerEntryRequestBody:
    ...
    entry_type: CreateLedgerEntryRequestBodyEntryType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('entry_type') }})
    ...
    invoice_settings: Optional[CreateLedgerEntryRequestBodyInvoiceSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('invoice_settings'), 'exclude': lambda f: f is None }})
    r"""Passing `invoice_settings` automatically generates an invoice for the newly added credits. If `invoice_settings` is passed, you must specify `per_unit_cost_basis`, as the calculation of the invoice total is done on that basis."""
...
class CreateLedgerEntryRequest:
    ...
    request_body: Optional[CreateLedgerEntryRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
