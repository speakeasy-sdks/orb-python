...
class AmendUsageRequestBody:
    ...
    events: list[AmendUsageRequestBodyEvents] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('events') }})
...
class AmendUsageRequest:
    ...
    request_body: Optional[AmendUsageRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class AmendUsageResponse:
    ...
    amend_usage_200_application_json_object: Optional[AmendUsage200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""
