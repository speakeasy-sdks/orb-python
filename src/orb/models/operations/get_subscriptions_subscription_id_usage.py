...
class GetSubscriptionsSubscriptionIDUsageGranularity(str, Enum):
...
class GetSubscriptionsSubscriptionIDUsageRequest:
    ...
    granularity: Optional[GetSubscriptionsSubscriptionIDUsageGranularity] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'granularity', 'style': 'form', 'explode': True }})
    r"""This determines the windowing of usage reporting."""
