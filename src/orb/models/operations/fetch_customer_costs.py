...
class FetchCustomerCostsViewMode(str, Enum):
...
class FetchCustomerCostsRequest:
    ...
    view_mode: Optional[FetchCustomerCostsViewMode] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'view_mode', 'style': 'form', 'explode': True }})
    r"""Controls whether Orb returns cumulative costs since the start of the billing period, or incremental day-by-day costs. If your customer has minimums or discounts, it's strongly recommended that you use the default cumulative behavior."""
...
class FetchCustomerCosts200ApplicationJSONDataPerPriceCosts:
    ...
    price_groups: list[FetchCustomerCosts200ApplicationJSONDataPerPriceCostsPriceGroups] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('price_groups') }})
...
class FetchCustomerCosts200ApplicationJSONData:
    ...
    per_price_costs: list[FetchCustomerCosts200ApplicationJSONDataPerPriceCosts] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('per_price_costs') }})
...
class FetchCustomerCosts200ApplicationJSON:
    ...
    data: list[FetchCustomerCosts200ApplicationJSONData] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})
...
class FetchCustomerCostsResponse:
    ...
    fetch_customer_costs_200_application_json_object: Optional[FetchCustomerCosts200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""
