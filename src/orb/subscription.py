...
class Subscription:
    ...
    def create(self, request: bytes) -> operations.CreateSubscriptionRawResponse:
        ...
        res = operations.CreateSubscriptionRawResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def create(self, request: operations.CreateSubscriptionApplicationJSON) -> operations.CreateSubscriptionJSONResponse:
        r"""Create subscription
        A subscription represents the purchase of a plan by a customer. The customer is identified by either the `customer_id` or the `external_customer_id`, and exactly one of these fields must be provided.
        ...
        res = operations.CreateSubscriptionJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
